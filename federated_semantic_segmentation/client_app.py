"""Client application for federated semantic segmentation.
   Versione aggiornata: usa local_steps invece di local_epochs.
"""
...
import time
# Importiamo Net, load_data e train_fn (local_steps)

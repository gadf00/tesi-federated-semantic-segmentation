# mm_model.py
# Early-fusion RGB+D LR-ASPP MobileNetV3 
...
# Rimosso: convert_bn_to_gn (non più necessario)
...
class EarlyFuseLRASPP(nn.Module):
    ...
    def __init__(
        ...
        # 4. (Rimosso) Conversione BN -> GN non più eseguita
